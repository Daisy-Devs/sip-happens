...
const CommonQuestions = () => {
  return (
    <section id="faq" className="max-w-4xl mx-auto px-5 md:px-30 mb-24 py-20">
      <h2 className="headline-lg text-primary text-center mb-12">
        Common Questions
      </h2>
      <div className="space-y-6">
        <details className="group bg-on-secondary p-6 rounded-lg cursor-pointer transition-all hover:bg-surface text-primary shadow-[0_8px_9px_#e5bfaa] border border-outline-variant/30">
