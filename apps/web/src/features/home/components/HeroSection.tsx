    ...
    <section className="relative overflow-hidden bg-background">
      <div className="mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl items-center px-5 py-16 sm:px-8 sm:py-20 md:px-12 lg:px-16 xl:px-20">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="mt-7 font-display text-4xl leading-[1.15] tracking-tight md:text-6xl"> <em className="headline-xxl">Sip Happens.</em>{" "} <span className="text-[#C68B59] headline-xxl">Great</span> <br className="hidden md:block" /> <span className="text-[#C68B59] headline-xxl">Coffee</span>{" "} <em className="headline-xxl">Happens Here.</em> </h1>
